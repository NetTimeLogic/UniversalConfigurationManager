...
void Ucm_PtpHcTab::ptp_hc_read_values(void)
{
        ...
        for (int i = 0; i < 10; i++)
        {
            if(0 == ucm->com_lib.read_reg(temp_addr + 0x00000100, temp_data))
            {
                if ((temp_data & 0x80000000) != 0)
                {
                    ...
                    {
                        ui->PtpHcDefaultDsPriority2Value->setText(QString("0x%1").arg(((temp_data >> 0) & 0x000000FF), 2, 16, QLatin1Char('0')));
                        ui->PtpHcDefaultDsPriority1Value->setText(QString("0x%1").arg(((temp_data >> 8) & 0x000000FF), 2, 16, QLatin1Char('0')));
        ...
        for (int i = 0; i < 10; i++)
        {
            if(0 == ucm->com_lib.read_reg(temp_addr + 0x00000400, temp_data))
            {
                if ((temp_data & 0x80000000) != 0)
                {
                    ...
                    {
                        ui->PtpHcParentDsGmPriority2Value->setText(QString("0x%1").arg(((temp_data >> 0) & 0x000000FF), 2, 16, QLatin1Char('0')));
                        ui->PtpHcParentDsGmPriority1Value->setText(QString("0x%1").arg(((temp_data >> 8) & 0x000000FF), 2, 16, QLatin1Char('0')));
    ...
    //********************************
    temp_data = 0x40000000;
    if (0 == ucm->com_lib.write_reg(temp_addr + 0x00000900, temp_data))
    {
        for (int i = 0; i < 10; i++)
        {
            if(0 == ucm->com_lib.read_reg(temp_addr + 0x00000900, temp_data))
            {
                if ((temp_data & 0x80000000) != 0)
                {
                    // nr of ports
                    if (0 == ucm->com_lib.read_reg(temp_addr + 0x0000091C, temp_data))
                    {
...
void Ucm_PtpHcTab::ptp_hc_write_values(void)
{
    ...
    else if (0 == ucm->com_lib.write_reg(temp_addr + 0x0000088C, temp_data))
    {
        temp_string.clear();
        temp_string.append(QString("%1").arg(((temp_data >> 0) & 0x000000FF), 2, 16, QLatin1Char('0')));
        temp_string.append(".");
    ...
    else if (0 == ucm->com_lib.write_reg(temp_addr + 0x00000904, temp_data))
    {
        temp_string.clear();
        temp_string.append(QString("%1").arg(((temp_data >> 0) & 0x000000FF), 2, 16, QLatin1Char('0')));
        temp_string.append(":");
        ...
        temp_data = temp_data << 8;
        temp_data |= (temp_mac >> 24) & 0x000000FF;
        if (0 == ucm->com_lib.write_reg(temp_addr + 0x00000908, temp_data))
        {
            temp_string.append(QString("%1").arg(((temp_data >> 0) & 0x000000FF), 2, 16, QLatin1Char('0')));
            temp_string.append(":");
            temp_string.append(QString("%1").arg(((temp_data >> 8) & 0x000000FF), 2, 16, QLatin1Char('0')));
    ...
    else if (0 == ucm->com_lib.write_reg(temp_addr + 0x0000090C, temp_data))
    {
        temp_data &= 0x000000FF;
        ui->PtpHcDefaultDsDomainValue->setText(QString("0x%1").arg(temp_data, 2, 16, QLatin1Char('0')));
