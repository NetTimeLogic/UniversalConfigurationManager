...
#ifndef UCM_DEBUGSTREAM_H
#define UCM_DEBUGSTREAM_H
...
{
public:
    Ucm_DebugStream(std::ostream &stream, QPlainTextEdit* text_edit) : debug_stream(stream)
    {
        line_nr = 0;
